...
> The variables of interest would be "genold", "party", "ngirls", "nboys", "totchi" and the controls the "region", the religion "rgroup", the race "white", the "age" and the service length "srvlng".

* drop all other variables.
```{r}
data %<>% 
  select("genold", "party", "ngirls", "nboys", "totchi" , "region", "rgroup", "white",  "age", "srvlng")
```
