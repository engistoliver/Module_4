...
regression <- lm(ngirls ~ genold + white + female + party + age + agesq + srvlng + srvlngsq + rgroup + region,con_gen_108)   # regressing ngirls on genold and controls

beta_ngirls <- summary(regression)$coefficients[2,1]

regression <- lm(totchi ~ genold + white + female + party + age + agesq + srvlng + srvlngsq + rgroup + region,con_gen_108,subset = (party=="D"))
