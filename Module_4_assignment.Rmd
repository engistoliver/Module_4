...
regression <- lm(totchi ~ genold + white + female + party + age + agesq + srvlng + 
...
regression <- lm(ngirls ~ genold + white + female + party + age + agesq + srvlng +
...
regression <- lm(totchi ~ genold + white + female + age + agesq + srvlng + 
                   srvlngsq + rgroup + region,con_gen_108,
                 subset = (party=="D" | name.x =="SANDERS, BERNARD"))
...
regression <- lm(ngirls ~ genold + white + female + age + agesq + srvlng + 
                   srvlngsq + rgroup + region + totchi_fac,con_gen_108,
                 subset = (party=="D" | name.x =="SANDERS, BERNARD"))
