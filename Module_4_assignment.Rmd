...
library(stargazer)
stargazer(reg_totchi_congress,reg_ngirls_congress,reg_totchi_D,reg_ngirls_D,reg_totchi_R,reg_ngirls_R,type='text', title="Regression Results", align=TRUE,column.labels = c("Congress","Democrats", "Republicans"), column.separate = c(2,2,2), digits=2, object.names = TRUE, keep = "genoldG" )
