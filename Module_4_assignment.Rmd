...
beta_vector <- matrix(c(beta_1, beta_1_g, beta_1_rep, beta_1_rep_g, beta_1_dem, beta_1_dem_g, sd_1, sd_1_g, sd_1_rep, sd_1_rep_g, sd_1_dem,sd_1_dem_g), nrow=2, ncol= 6)
colnames(beta_vector) <- c('Total Children', 'Girls','Total Children', 'Girls','Total Children', 'Girls')
rownames(beta_vector) <- c('Beta', 'Standard Error')
