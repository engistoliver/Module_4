...
library(stargazer)
stargazer(reg1 ,reg2,reg3,reg4,reg5,reg6,type='text', title="Regression Results", align=TRUE,column.labels = c("Congress","Democrats", "Republicans"), column.separate = c(2,2,2), digits=2, object.names = TRUE, keep = "genoldB" )
