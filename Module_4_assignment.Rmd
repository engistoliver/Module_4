...
X <- congress.data %>% matrix(c(congress.data$party, congress.data$rgroup, congress.data$region, congress.data$age, congress.data$female, congress.data$white, congress.data$srvlng))

lm($totchi = \beta_0 + \beta_1 genold + \gamma'X$, congress.data)
