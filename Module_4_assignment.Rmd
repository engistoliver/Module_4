...
basic108_data <- left_join(basic108_data, genold_data, by = c('name', 'district', 'statenam'))
```
...
```{r}
op_data <- select(basic108_data, white, genold, party, age, srvlng, rgroup, region, ngirls, totchi)
...
op_data <- mutate(op_data, age_aqr = age^2, srvlng_sqr = srvlng^2)
