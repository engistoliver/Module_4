...
```{r}
reg_totchi_congress <- lm(totchi~ genold + age + age_sq + party + srvlng + srvlng_sq + rgroup + region, combined_dataset)
```
...
reg_totchi_D <- lm(totchi~ genold + age + age_sq + srvlng + srvlng_sq + rgroup + region, combined_dataset, party == "D")
reg_totchi_R <- lm(totchi~ genold + age + age_sq + srvlng + srvlng_sq + rgroup + region, combined_dataset, party == "R")
...
reg_ngirls_congress <- lm(ngirls~ genold + age + age_sq + party + srvlng + srvlng_sq + rgroup + region, combined_dataset)
reg_ngirls_D <- lm(ngirls~ genold + age + age_sq + srvlng + srvlng_sq + rgroup + region, combined_dataset, party == "D")
reg_ngirls_R <- lm(ngirls~ genold + age + age_sq + srvlng + srvlng_sq + rgroup + region, combined_dataset, party == "R")
