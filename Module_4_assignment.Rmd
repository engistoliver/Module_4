...
library(stargazer)
print(stargazer(reg_totchi_congress,reg_ngirls_congress,reg_totchi_D,reg_ngirls_D,reg_totchi_R,reg_ngirls_R, title="Regression Results", align=TRUE, dep.var.labels=c("Full Congress","Democrats", "Republican")))
