...
appendix_var <- select(genold_data, white, female, party, age, srvlng, repub, rgroup, region, totchi, ngirls, anygirls, demvote, genold)
```

* Recode *genold* such that gender is a factor variable and missing values are coded as NAs.
```{r genold factors, message=FALSE}
appendix_var$genold <- appendix_var %>% as.factor(genold)
