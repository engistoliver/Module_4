...
reg1 <- lm(ngirls~ genold + white + female + party + age + age_squared + srvlng + srvlng_squared + rgroup + region + totchi,Combined)

reg2 <- lm(totchi~ genold + white + female + party + age + age_squared + srvlng + srvlng_squared + rgroup + region,Combined)


# Regressions Democrat
reg3 <- lm(ngirls~ genold + white + female + age + age_squared + srvlng + srvlng_squared + rgroup + region + totchi,Combined_Dem)

reg4 <- lm(totchi~ genold + white + female + age + age_squared + srvlng + srvlng_squared + rgroup + region,Combined_Dem)

# Regressions Republican
reg5 <- lm(ngirls~ genold + white + female + age + age_squared + srvlng + srvlng_squared + rgroup + region + totchi,Combined_Rep)

reg6 <- lm(totchi~ genold + white + female + age + age_squared + srvlng + srvlng_squared + rgroup + region,Combined_Rep)

# collect beta_1 coefficients
beta_1 <- c(reg1$coefficients[2],reg2$coefficients[2],reg3$coefficients[2],reg4$coefficients[2],reg5$coefficients[2],reg6$coefficients[2])
